...
public class FastSortTest {
    ...
    public static void main(String args []){
        ...
        fastsort(origion,0,origion.length-1);
        for(int i : origion){
            System.out.print(i +" " );
        }
    }

    public static void fastsort(int [] list, int low, int high){
        ...
        fastsort(list,low,middleIndex-1);
        fastsort(list,middleIndex+1,high);
